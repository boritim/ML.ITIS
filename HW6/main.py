...
print(target)
sns.pairplot(iris_df, hue='target', height=2, diag_kind="kde")
...
sns.pairplot(iris_df_norm, hue='target', height=2, diag_kind="kde")
...
sns.pairplot(X_test, hue='real_target', height=2, diag_kind="kde", hue_order=['versicolor', 'virginica', 'setosa'])

sns.pairplot(X_test, hue='pred_target', height=2, diag_kind="kde", hue_order=['versicolor', 'virginica', 'setosa'])
plt.show()
